  ...
  n.length &&
    ((t = n.DataTable({
      ...
      buttons: [
        ...
        {
          text: '<i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span class="d-none d-sm-inline-block">Add Subject</span>',
          className:
          ...
          init: function(api, node, config) {
            ...
            $(node).attr('data-bs-target', '#addSubject');
          }
        },
      ],
      responsive: {
